...
func (st *State) Update(ctx context.Context, curVersion resource.Version, new resource.Resource, opts ...state.UpdateOption) error {
	return st.getNamespace(new.Metadata().Namespace()).Update(ctx, curVersion, new, opts...)
}
