...
func file_v1alpha1_meta_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_v1alpha1_meta_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_v1alpha1_meta_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_v1alpha1_meta_proto_msgTypes[2].Exporter = func(v any, i int) any {
